...
- Claim it by updating the task card and `.agents/tasks/index.md` to `DOING`.
...
- If no actionable `TODO` exists, append a short note to `.agents/tasks/notes.md` and stop.

...
description: "Inspect repository reality, then add at most one new task card written as a direct user prompt in prompt-tasks/tasks/ without flooding the queue."
---
...
- Running `prompt-tasks/.agents/loop/producer.md`
...
- `prompt-tasks/AGENTS.md`
- `prompt-tasks/tasks/context.md`
- `prompt-tasks/tasks/index.md`
- `prompt-tasks/tasks/notes.md`
...
- create one `prompt-tasks/tasks/PT-<date>-<random>.md` card
- initialize it from `prompt-tasks/tasks/templates/task.template.md`
- set `Status: TODO`
- write a concrete `User Prompt` section with scope, constraints, validation, and expected evidence
- update `prompt-tasks/tasks/index.md` in the same round

When you do not create a new task:

- append a short dated reason to `prompt-tasks/tasks/notes.md`
